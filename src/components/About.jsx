    ...
    <div id="about" className="bg-[#ffffff] min-h-screen flex items-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        ...
        <p className="text-lg md:text-xl text-gray-700 text-center leading-relaxed">
          I’m <span className="font-bold text-[#fe5617]">Nishaanth R</span>, an
          IT student passionate about{" "}
          <span className="font-bold text-[#fe5617]">web development</span> and
          <span className="font-bold text-[#fe5617]">
            {" "}
            software engineering
          </span>
          . I enjoy building user-friendly web applications and continuously
          improving my skills. I have worked on projects like{" "}
          <span className="font-bold text-[#fe5617]">MERN Stack project</span>
          and a <span className="font-bold text-[#fe5617]">React project</span>.
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="flex flex-col items-center space-y-2">
              <FaJava size={40} className="text-[#264de4]" />
